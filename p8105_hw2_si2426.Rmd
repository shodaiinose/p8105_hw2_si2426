...
```
We have cleaned the original data by altering some of the variables, removing rows that do not include dumpster-specific data, and rounding the number of sports balls collected. We have also added a `type` variable to indicate that the data belongs to Mr. Trash Wheel.
